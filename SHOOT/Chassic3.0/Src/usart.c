...
void MX_USART1_UART_Init(void)
{
  ...
  __HAL_UART_ENABLE_IT(&huart1, UART_IT_IDLE);
	HAL_UART_Receive_DMA(&huart1, UART1_RXBUFF,100);
}
...
void MX_USART2_UART_Init(void)
{
  ...
  if (HAL_UART_Init(&huart2) != HAL_OK)
  {
	...
	HAL_UART_Receive_DMA(&huart2,UART2_RXBUFF, UART2_RXBUFF_SIZE);
...
void MX_USART3_UART_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart3,UART3_RXBUFF,UART3_RXBUFF_SIZE);
}
...
void MX_USART6_UART_Init(void)
{
  ...
  if (HAL_UART_Init(&huart6) != HAL_OK)
  {
	...
	HAL_UART_Receive_DMA(&huart6,UART6_RXBUFF, UART6_RX_BUF_LEN);
}
...
void MX_UART7_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart7,UART7_RXBUFF,UART7__RX_BUF_LEN);
}
